...
def test_add(ctx: CryptoContext, tmp_path):
    ...
    {FHETCH_PRIMES}
    def main() {{
        var ct_0: MRP<u32, 1024, Q> = read_mrp_u32_Q("{tmp}/ct_0.npz",Q);
        var ct_1: MRP<u32, 1024, Q> = read_mrp_u32_Q("{tmp}/ct_1.npz",Q);
        var s0 = ct_0 + ct_0;
        var s1 = ct_1 + ct_1;
        write_mrp_u32(s0,"{tmp}/ct_res_0.npz");
        write_mrp_u32(s1,"{tmp}/ct_res_1.npz");
    }}
    """
    ).program
...
def test_mult(ctx: CryptoContext, tmp_path):
    ...
    def main() {{
        ...
        var ct_b0: MRP<u32, 1024, Q> = read_mrp_u32_Q("{tmp}/ct_b0.npz",Q);
        var ct_b1: MRP<u32, 1024, Q> = read_mrp_u32_Q("{tmp}/ct_b1.npz",Q);

        var prod0 = ct_a0 * ct_b0;
        var prod1 = ct_a0 * ct_b1 + ct_a1 * ct_b0;
        var prod2 = ct_a1 * ct_b1;

        var relin_d0_0: MRP<u32, 1024, QP> = read_mrp_u32_Q("{tmp}/relin_d0_0.npz",QP);
        var relin_d0_1: MRP<u32, 1024, QP> = read_mrp_u32_Q("{tmp}/relin_d0_1.npz",QP);
        var relin_d1_0: MRP<u32, 1024, QP> = read_mrp_u32_Q("{tmp}/relin_d1_0.npz",QP);
        var relin_d1_1: MRP<u32, 1024, QP> = read_mrp_u32_Q("{tmp}/relin_d1_1.npz",QP);
        var relin_d2_0: MRP<u32, 1024, QP> = read_mrp_u32_Q("{tmp}/relin_d2_0.npz",QP);
        var relin_d2_1: MRP<u32, 1024, QP> = read_mrp_u32_Q("{tmp}/relin_d2_1.npz",QP);
        var relin_d3_0: MRP<u32, 1024, QP> = read_mrp_u32_Q("{tmp}/relin_d3_0.npz",QP);
        var relin_d3_1: MRP<u32, 1024, QP> = read_mrp_u32_Q("{tmp}/relin_d3_1.npz",QP);
        var relin_d4_0: MRP<u32, 1024, QP> = read_mrp_u32_Q("{tmp}/relin_d4_0.npz",QP);
        var relin_d4_1: MRP<u32, 1024, QP> = read_mrp_u32_Q("{tmp}/relin_d4_1.npz",QP);
